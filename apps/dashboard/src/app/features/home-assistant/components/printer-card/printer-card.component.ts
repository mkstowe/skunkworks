...
export class PrinterCardComponent implements OnInit {
  ...
  public details = signal<PrinterDetails | null>(null);
  public active = computed(() =>
    this.printerService.isActive(this.details()?.printStatus)
  );
  public elapsedTime = computed(() => {
    return this.details() && this.details()!.startTime
